package com.fcb.coupon.common.file;
...
public class CommonMultipartFile implements MultipartFile {
    ...
    public CommonMultipartFile(String name, @Nullable String originalFilename, @Nullable String contentType, @Nullable byte[] content) {
    ...
    public CommonMultipartFile(String name, @Nullable String originalFilename, @Nullable String contentType, InputStream contentStream) throws IOException {
