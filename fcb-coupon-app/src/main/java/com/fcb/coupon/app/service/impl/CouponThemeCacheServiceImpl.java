...
public class CouponThemeCacheServiceImpl extends ServiceImpl<CouponThemeMapper, CouponThemeEntity> implements CouponThemeCacheService {
     ...
     */
    @Override
    public List<CouponThemeCache> listCouponTheme(List<Long> themeIds) {
        List<CouponThemeCache> couponThemeCaches = new ArrayList<>(themeIds.size());
        for (Long themeId : themeIds) {
            CouponThemeCache couponThemeCache = getById(themeId);
            couponThemeCaches.add(couponThemeCache);
        }
        return couponThemeCaches;
    }
}
