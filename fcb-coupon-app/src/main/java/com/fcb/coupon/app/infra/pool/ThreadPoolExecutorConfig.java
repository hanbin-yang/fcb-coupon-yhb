...
public class ThreadPoolExecutorConfig {
    ...
    @Bean(name = "couponVerificationOprExecutor")
    public ThreadPoolTaskExecutor couponVerificationOprExecutor() {
        ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
        ...
        executor.setThreadNamePrefix("couponVerificationOprExecutor-");
