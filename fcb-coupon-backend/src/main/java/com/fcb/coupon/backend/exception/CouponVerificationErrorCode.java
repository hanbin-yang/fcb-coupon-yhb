...
public enum CouponVerificationErrorCode implements ResponseErrorCode {
    ...
    COUPON_CODE_USED("250002", "重复核销，券码已被核销！"),
    ...
    COUPON_STATUS_NOT_ISSUE_OR_USED("250014", "券不是可使用或已发行状态"),
    COUPON_CODE_NOT_UNIQUE("250015", "券码不唯一"),
    COUPON_CODE_NULL("250016", "优惠券码不能为空"),
    SUBSCRIBE_CODE_NULL("250017", "明源认购书不能为空"),
    VERIFY_PHONE_NULL("250018", "核销手机号不能为空"),
    BUILD_CODE_NULL("250019", "楼盘编码不能为空"),
    COUPON_VERIFICATION_NOT_EXIST("250020", "核销记录不存在"),
    SUBSCRIBE_CODE_FORMAT_ERROR("250021", "认购书编号格式不正确，由G+7位数字组成"),
    VERIFY_TEMPLATE_DATA_EMPTY("250022", "核销模板没有数据"),
    PHONE_NOT_REGISTER("250023", "该手机号未注册"),
    ACCOUNT_DISABLE("250024", "该账号被禁用"),
    REPEAT_VERIFY("250025", "券码已在核销中，请勿重复操作"),
    COUPON_THEME_NOT_EXIST("250026", "券活动不存在"),
    ;
