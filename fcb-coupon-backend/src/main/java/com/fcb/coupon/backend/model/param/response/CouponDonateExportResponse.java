 ...
 **/
@XSheet(name = "赠送优惠券明细")
@ApiModel(value="赠送优惠券明细",description="赠送优惠券明细")
@Data
public class CouponDonateExportResponse implements Serializable {

    private static final long serialVersionUID = -1797643316664188562L;
