 ...
 */
@Data
@ApiModel(description = "审核不通过--入参")
public class CouponThemeAuditNotPassRequest implements Serializable {
    private static final long serialVersionUID = -1205425807823693476L;
