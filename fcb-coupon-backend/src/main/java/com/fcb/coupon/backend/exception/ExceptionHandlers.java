...
public class ExceptionHandlers {
    ...
    public ResponseDto<Void> handleBusinessException(BusinessException e) {
        ...
        return BackendResponseUtil.fail(e.getCode(), e.getMessage());
    }
    ...
    public ResponseDto handleNoHandlerFoundException(Exception ex) {
        ...
        return BackendResponseUtil.fail(businessException.getCode(), businessException.getMessage());
    }
    ...
    public ResponseDto handleMissingServletRequestParameterException(MissingServletRequestParameterException ex) {
        ...
        return BackendResponseUtil.fail(CommonErrorCode.PARAMS_ERROR.getCode(), errorMesssage);
    }
