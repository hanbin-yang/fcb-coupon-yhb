...
import com.fcb.coupon.backend.model.bo.MktUseRuleOrgListBo;
...
@Data
public class MktUseRuleOrgListRequest extends AbstractBaseConvertor<MktUseRuleOrgListBo> implements Serializable {
    ...
    @Override
    public MktUseRuleOrgListBo convert() {
        MktUseRuleOrgListBo bo = new MktUseRuleOrgListBo();
