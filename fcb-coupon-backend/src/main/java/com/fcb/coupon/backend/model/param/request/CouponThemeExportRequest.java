...
import com.fcb.coupon.backend.model.bo.CouponThemeExportBo;
 ...
 */
@ApiModel(description = "导出券活动列表-入参")
@Data
public class CouponThemeExportRequest extends AbstractBaseConvertor<CouponThemeExportBo> implements Serializable {
    ...
    @Override
    public CouponThemeExportBo convert() {
        CouponThemeExportBo bo = new CouponThemeExportBo();
